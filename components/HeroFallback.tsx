...
// Fallback do Hero — versão CSS pura, zero dependência de WebGL.
// Cópia intencional do conteúdo (inline, sem importar HeroContent)
// para ser 100% independente do pipeline 3D. Não modificar sem motivo.
